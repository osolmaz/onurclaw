...
function cacheDynamicModels(key, models) {
...
function dynamicModelScopeKey(ctx) {
    return [
...
function toRuntimeModel(model, providerConfig) {
    return {
        ...model.config,
...
function toUnifiedCatalogEntry(model, fetchedAt) {
...
async function discoverFromCatalogContext(ctx) {
...
export async function discoverLlamaServerProvider(ctx) {
...
export async function listLlamaServerCatalog(ctx) {
...
export async function prepareLlamaServerDynamicModels(ctx) {
    ...
    cacheDynamicModels(key, discovery.kind === "success"
...
export function clearLlamaServerDynamicModelsForTests() {
    dynamicModels.clear();
}
