...
import { hasLlamaServerAuthorizationHeader, shouldUseLlamaServerSyntheticAuth, } from "./src/auth.js";
...
export default definePluginEntry({
    ...
    register(api) {
        ...
        api.registerProvider({
            ...
            resolveSyntheticAuth: ({ providerConfig }) => shouldUseLlamaServerSyntheticAuth(providerConfig)
                ? {
                ...
                : undefined,
            shouldDeferSyntheticProfileAuth: ({ resolvedApiKey }) => resolvedApiKey?.trim() === LLAMA_SERVER_LOCAL_AUTH_MARKER ||
