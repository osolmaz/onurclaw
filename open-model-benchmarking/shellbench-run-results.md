...
These runs used Harbor with stock OpenClaw embedded runtime, the Ollama Cloud OpenAI-compatible API at `https://ollama.com/v1`, and the same Codex-backed verifier judge. All models received the same public task instructions with no extra model-specific instructions.
...
<details open>
<summary>Hosted Ollama Cloud task-by-model matrix</summary>
